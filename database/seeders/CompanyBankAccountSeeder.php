...
class CompanyBankAccountSeeder extends Seeder
{
    ...
    {
        $servicon = Company::where('cnpj', '03.225.148/0001-12')->first()
            ?? Company::where('cnpj', '03225148000112')->first();

        $lara = Company::where('cnpj', '44.053.313/0001-83')->first()
            ?? Company::where('cnpj', '44053313000183')->first();
