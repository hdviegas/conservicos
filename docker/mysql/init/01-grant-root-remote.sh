...
FLUSH PRIVILEGES;
ALTER USER 'root'@'localhost' IDENTIFIED BY 'Db@2415G1354@';
CREATE USER IF NOT EXISTS 'root'@'%' IDENTIFIED BY 'Db@2415G1354@';
ALTER USER 'root'@'%' IDENTIFIED BY 'Db@2415G1354@';
GRANT ALL PRIVILEGES ON *.* TO 'root'@'%' WITH GRANT OPTION;
FLUSH PRIVILEGES;
